...
/**
 * Servlet implementation class InfoMateria
 */
@WebServlet("/Materia/Info")
public class InfoMateria extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usrLogeado == null) {
			...
			getServletConfig().getServletContext().getRequestDispatcher("/vistas/materia/info.jsp").forward(request, response);
		}
	}
