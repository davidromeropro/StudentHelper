...
%>
              <form class="form-horizontal style-form" method="post">
                <input name="nombreMat" type="text" class="form-control" value="<%=mat.getNombre()%>">
                <br>
                <input name="profesorMat" type="text" class="form-control" value="<%=mat.getProfesor()%>">
                <br>
                <input name="aulaMat" type="text" class="form-control" value="<%=mat.getAula()%>">
