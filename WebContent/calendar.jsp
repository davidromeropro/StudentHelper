...
<meta charset="utf-8">
    ...
    <title>SOFTWARS - Prototipo - Calendario</title>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="calendar.jsp">
          ...
          <section class="wrapper">
              ...
              <div class="row mt">
                  <aside class="col-lg-3 mt">
                      <h4><i class="fa fa-angle-right"></i> Arrastra las tareas</h4>
                      <div id="external-events">
                          <div class="external-event label label-theme">Tarea    1</div>
                          <div class="external-event label label-success">Tarea 2</div>
                          <div class="external-event label label-info">Tarea 3</div>
                          <div class="external-event label label-warning">Tarea 4</div>
                          <div class="external-event label label-danger">Tarea 5</div>
                          <div class="external-event label label-default">Tarea 6</div>
                          <div class="external-event label label-theme">Tarea 7</div>
                          <div class="external-event label label-info">Tarea 8</div>
                          <div class="external-event label label-success">Tarea 9</div>
                          <p class="drop-after">
